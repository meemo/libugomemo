...
double framerates[11] = { 0.2, 0.5, 1, 2, 4, 6, 8, 12, 20, 24, 30 };

// Audio decoding tables
int16_t adpcm_step_table_2b[4] = { -1, 2, -1, 2 };
int16_t adpcm_index_table_2b[4] = { -1, 2, -1, 2 };
int16_t adpcm_sample_table_2b[360] = { 0 };
int16_t adpcm_step_table_4b[16] = { -1, -1, -1, -1, 2, 4, 6, 8, -1, -1, -1, -1, 2, 4, 6, 8 };
int16_t adpcm_index_table_4b[16] = { -1, -1, -1, -1, 2, 4, 6, 8, -1, -1, -1, -1, 2, 4, 6, 8 };
int16_t adpcm_sample_table_4b[1440] = { 0 };
uint16_t adpcm_step_table[96] = { 7, 8, 9, 10, 11, 12, 13, 14, 16, 17, 19,
...
uint16_t common_line_index_table[32] = { 0x0000, 0x0CD0, 0x19A0, 0x02D9, 0x088B, 0x0051, 0x00F3, 0x0009,
										 0x001B, 0x0001, 0x0003, 0x05B2, 0x1116, 0x00A2, 0x01E6, 0x0012,
										 0x0036, 0x0002, 0x0006, 0x0B64, 0x08DC, 0x0144, 0x00FC, 0x0024,
										 0x001C, 0x0004, 0x0334, 0x099C, 0x0668, 0x1338, 0x1004, 0x166C };
uint16_t common_line_index_table_shifted[32] = { 0x0000, 0x0CD0, 0x19A0, 0x0003, 0x02D9, 0x088B, 0x0051, 0x00F3,
