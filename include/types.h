...
typedef struct KFH {
    ...
    wchr root_author_username[11];  // Names are stored in little endian wchars (UTF-16 LE)
    wchr parent_author_username[11];
    wchr current_author_username[11];
